<%@ Page Title="Teacher's Login" Language="C#" MasterPageFile="~/PublicSite.Master" AutoEventWireup="true" CodeBehind="TeacherLogin.aspx.cs" Inherits="AHR_School_And_College.TeacherLogin" %>
                ...
                <div class="col-lg-7 mx-auto">
                    <div class="position-relative col-lg-9 login-box mx-auto  d-flex flex-column m-auto min-vh-75">
                        ...
                        <div class="login-avatar-box mt-3">
                            <img runat="server" src="~/image/3d-man-2.png" alt="avatar" />
                        </div>
                        <h3 class="sub-title text-center p-1 font-1 bg-primary max-width-100 radius-5 f-light mx-auto mb-4">Teacher</h3>
