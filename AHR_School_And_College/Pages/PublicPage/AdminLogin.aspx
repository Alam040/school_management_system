<%@ Page Title="Admin Login" Language="C#" MasterPageFile="~/PublicSite.Master" AutoEventWireup="true" CodeBehind="AdminLogin.aspx.cs" Inherits="AHR_School_And_College.AdminLogin" %>
                ...
                <div class="col-lg-7 mx-auto">
                    <div class="position-relative col-lg-9 login-box mx-auto  d-flex flex-column m-auto min-vh-75">
                        ...
                        <div class="login-avatar-box mt-3">
                            <img runat="server" src="~/image/3d-man-1.png" alt="avatar" />
                        </div>
                        <h3 class="sub-title text-center p-1 font-1 bg-warning max-width-100 radius-5 f-dark mx-auto mb-4">Admin</h3>
                        ...
                        <div class="d-flex flex-column justify-content-between">
                            <%--<div class="">
                                <asp:CheckBox CssClass="font-1 d-flex align-items-center gap-1" ID="ckb_1_t" runat="server" Text="Save Login" Checked="true" TabIndex="3"  />
                            </div>
                            <a tabindex="4" class="a-link f-dark font-1 text-right mb-2 pointer">forgot Password?</a>--%>
                            <label>Password: admin</label>
                            <asp:Label CssClass="a-link f-dark font-1 text-right mb-2 pointer f-red" runat="server" ID="lbl" />
                        </div>
                        <div class="d-flex align-items-center justify-content-center py-3 min-w-150 mb-5">
                            <asp:Button
                                ...
                                OnClick="admin_login_submit_Click"
                                runat="server"
                                TabIndex="5"
                                Type="submit"
                                Text="Login" />
